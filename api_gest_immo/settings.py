"""
Django settings for api_gest_immo project.
...
SECRET_KEY = 'django-insecure-2y^)eu*#a8ba15z8@yd+_2a45@m+a4f_ta#e@2kcy03xn=f1lg'
...
ROOT_URLCONF = 'api_gest_immo.urls'
...
WSGI_APPLICATION = 'api_gest_immo.wsgi.application'
